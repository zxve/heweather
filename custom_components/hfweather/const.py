...
TIME_BETWEEN_UPDATES = timedelta(minutes=600)
...
OPTIONS = {
    ...
    "humidity": [DEVICE_CLASS_HUMIDITY, "室外湿度", "mdi:water-percent", PERCENTAGE, PERCENTAGE],
    ...
    "dew": [SensorDeviceClass.TEMPERATURE, "露点温度", "mdi:thermometer-water", SensorDeviceClass.TEMPERATURE,
            UnitOfTemperature.FAHRENHEIT],
    "pressure": [DEVICE_CLASS_PRESSURE, "大气压强", "mdi:thermometer", UnitOfPressure.HPA, UnitOfPressure.HPA],
    ...
    "pm25": [DEVICE_CLASS_PM25, "PM2.5", "mdi:walk", CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
             CONCENTRATION_MICROGRAMS_PER_CUBIC_FOOT],
    "pm10": [DEVICE_CLASS_PM10, "PM10", "mdi:walk", CONCENTRATION_MICROGRAMS_PER_CUBIC_METER,
             CONCENTRATION_MICROGRAMS_PER_CUBIC_FOOT],
